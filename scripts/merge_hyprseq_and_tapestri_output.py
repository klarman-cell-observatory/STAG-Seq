...
def plot_non_intersecting_hyprseq_barcodes(intersecting_barcodes_df, non_intersecting_barcodes_df, save_path, plot = True):
...
if __name__ == "__main__":
    ...
    non_intersecting_barcodes = mdata.mod["HyPR"][
        mdata.mod["HyPR"].obs["intersecting"] == False
    ].copy()
    ...
    intersecting_barcodes = mdata.mod["HyPR"][
    ...
    plot_non_intersecting_hyprseq_barcodes(intersecting_barcodes_df, non_intersecting_barcodes_df, intermediate_fig_path, plot=True)
